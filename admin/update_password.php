...
<tr>
    ...
    <input type="password" name="op" value="" class="form-control" required/></th>
</tr>
	
<tr>
	<th height="93">New Password:
    <input type="password" name="np" value=""  class="form-control"  required/><br /></th>
</tr>
 
<tr>
	<th height="87">Confirm Password:
    <input type="password" name="cp" value="" class="form-control" required/><br /></th>
</tr>
<tr>
