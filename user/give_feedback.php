...
<form method="post">
<fieldset>
<center><h3><u>STUDENT'S FEEDBACK FORM</u></h3></center><br> 
...
<center>
<button type="button" style="font-size:10pt;color:white;background-color:green;border:2px solid #336600;border-radius:20px; padding:10px">Strongly Agree 5</button>
<button type="button" style="font-size:10pt;color:white;background-color:Brown;border:2px solid #336600; border-radius:20px; padding:10px">Agree 4</button>
<button type="button" style="font-size:10pt;color:white;background-color:blue;border:2px solid #336600;border-radius:20px; padding:10px">Neutral 3</button>
<button type="button" style="font-size:10pt;color:white;background-color:Black;border:2px solid #336600; border-radius:20px; padding:10px"> Disagree 2</button>
<button type="button" style="font-size:10pt;color:white;background-color:red;border:2px solid #336600; border-radius:20px; padding:10px">Strongly Disagree 1</button><br>
</center>
...
<br>
<p align="center"><button type="submit" class="btn-success3" name="sub">Submitt</button></p>
